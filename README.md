...
| MagickPen          | gpt-4o-mini                               | ▶️       | ![Active][active-badge] | Very fast      | 8.5/10, authentic GPT-4o-mini model                                                           |
| Google Gemini      | auto (gemini-1.5-pro or gemini-1.5-flash) | ▶️ 📄    | ![Active][active-badge] | Very fast      | 8.5/10, very good overall model but requires an API Key. (It's *free*, see the section below) |
