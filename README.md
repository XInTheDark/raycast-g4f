...
| Google Gemini      | gemini-1.5-flash-latest | ✅         | ![Active][active-badge]   | Very fast | 8.5/10, very good overall model but requires an API Key. (It's *free*, see the section below) |
